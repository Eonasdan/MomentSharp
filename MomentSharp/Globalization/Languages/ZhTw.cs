...
public class ZhTw : ILocalize
{
    ...
    public string Translate(RelativeTime relativeTime, int number, bool showSuffix, bool isFuture)
    {
        ...
        {
            RelativeTime.Seconds => "幾秒",
            RelativeTime.Minute => "1 分鐘",
            RelativeTime.Minutes => $"{number} 分鐘",
            RelativeTime.Hour => "1 小時",
            RelativeTime.Hours => $"{number} 小時",
            RelativeTime.Day => "1 天",
            RelativeTime.Days => $"{number} 天",
            RelativeTime.Month => "1 個月",
            RelativeTime.Months => $"{number} 個月",
